...
/// ULA (Unique Local Address) prefix segments for publisher addresses
/// Format: fde5:402f:ab0a:1::/64
pub const ULA_PREFIX_SEGMENT_0: u16 = 0xfde5;
pub const ULA_PREFIX_SEGMENT_1: u16 = 0x402f;
pub const ULA_PREFIX_SEGMENT_2: u16 = 0xab0a;
pub const ULA_PREFIX_SEGMENT_3: u16 = 0x0001;
